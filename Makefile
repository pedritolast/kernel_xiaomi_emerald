...
# =============N6R PROJECT===============
$(warning EU_50w_func = $(EU_50W_FUNC), eea is 1 ,other is 0)
ifeq ($(EU_50W_FUNC),1)
KBUILD_CFLAGS += -DPRODUCT_EU_50W
$(warning KRN_PROJECT = $(KBUILD_CFLAGS))
$(warning Starting the build process DPRODUCT_EU_50W )
else
$(warning Starting the build process global DPRODUCT_EU_50W_NO )
endif
# =============N6R  PROJECT=============
